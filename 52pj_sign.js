...
const CookieWA = 'htVD_2132_connect_is_bind=1; htVD_2132_connect_uin=A3E7890321E0B9B83DA9D31A55C35172; htVD_2132_nofavfid=1; htVD_2132_smile=1D1; htVD_2132_client_token=A3E7890321E0B9B83DA9D31A55C35172; htVD_2132_saltkey=Z6w330X3; htVD_2132_lastvisit=1604031980; htVD_2132_client_created=1604368553; htVD_2132_auth=3e8e1OBQW3i77KwGeJjDY5RuN46geGavkj0OLTGE4FWenBM3lHbM44HdsC0eJLejp8MxGrPd8xIMj7Dy72ctBGjVmmE; htVD_2132_connect_login=1; htVD_2132_ignore_rate=1; htVD_2132_forum_lastvisit=D_39_1605073685; htVD_2132_visitedfid=39D13D16D8D10; htVD_2132_sid=0; KF4=b9Oy10; htVD_2132_ulastactivity=1605348532%7C0; htVD_2132_checkpm=1; Hm_lvt_46d556462595ed05e05f009cdafff31a=1604986314,1605062120,1605073530,1605348539; htVD_2132_home_readfeed=1605348616; htVD_2132_lastcheckfeed=652075%7C1605348617; htVD_2132_checkfollow=1; Hm_lpvt_46d556462595ed05e05f009cdafff31a=1605348624; htVD_2132_lastact=1605348619%09plugin.php%09';
  ...
  $.get({
    ...
    if (error && !data) {
      ...
      if (data.match(/(ÒÑÍê³É|\u606d\u559c\u60a8|��̳΢�š��ᰮ�ƽ�)/)) {
        notify.sendNotify("吾爱破解签到", date.getMonth() + 1 + "月" + date.getDate() + "日, 签到成功 🎉");
        ...
        notify.sendNotify("吾爱破解签到失败，cookie失效！！！", '');
